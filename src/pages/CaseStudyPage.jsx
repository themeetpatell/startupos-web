  ...
  const caseStudies = [
    {
      ...
      solution: "Leveraged Biggbizz ecosystem to connect with strategic investors, technical mentors, and enterprise customers. Used AI Co-Builders to accelerate product development.",
      results: [
      ...
      story: "Alex started DataFlow with just a vision and $50K in savings. Through Biggbizz, he connected with mentors who helped refine his pitch and business model. The AI Co-Builders accelerated development by 6 months, and strategic introductions led to meetings with top-tier VCs.",
    ...
    },
    {
      ...
      solution: "Utilized Biggbizz mentor network for industry expertise, connected with corporate partners through ecosystem, and leveraged fractional CXO services for strategic guidance.",
      results: [
      ...
      story: "Sarah's journey from a small startup to a market leader in clean energy was accelerated by Biggbizz's ecosystem. The mentor network provided crucial industry insights, while corporate partnerships opened doors to enterprise customers.",
    ...
    },
    {
      ...
      solution: "Leveraged Biggbizz legal and compliance expertise, connected with healthcare industry mentors, and used ecosystem resources for regulatory navigation.",
      results: [
      ...
      story: "Marcus faced the daunting challenge of healthcare regulations. Biggbizz connected him with healthcare industry veterans who guided him through compliance requirements and helped build strategic partnerships.",
    ...
    },
    {
      ...
      solution: "Used Biggbizz ecosystem for regulatory guidance, connected with fintech mentors, and leveraged strategic partnerships for market expansion.",
      results: [
      ...
      story: "Priya's fintech startup was acquired by a major financial institution for $200M. Biggbizz played a crucial role in connecting her with the right mentors and advisors who helped navigate the complex acquisition process.",
    ...
    },
    {
      ...
      solution: "Leveraged Biggbizz ecosystem for strategic partnerships, used AI Co-Builders for platform optimization, and connected with education industry mentors.",
      results: [
      ...
      story: "David's education platform grew from a small startup to serving 500K+ students globally. Biggbizz's ecosystem provided crucial connections with education partners and helped optimize the platform using AI technology.",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed mb-12">
              ...
              with the help of Biggbizz ecosystem. Learn from real challenges, solutions, and outcomes.
            </p>
